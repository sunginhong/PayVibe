...
public class Activity_Set_2Anim extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lottieview_once.setAnimation("wav_anim_0once_bounce.json");
        lottieview_loop = findViewById(R.id.lottieview_loop);
        lottieview_loop.setAnimation("wav_anim_1loop_bounce.json");
